...
/* harmony import */ var _modules_scrollToAnchor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/scrollToAnchor */ "./src/js/modules/scrollToAnchor.js");
...
/* harmony import */ var _modules_modalsEvents__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/modalsEvents */ "./src/js/modules/modalsEvents.js");
/* harmony import */ var _modules_Forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/Forms */ "./src/js/modules/Forms.js");
/* harmony import */ var _modules_popups__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/popups */ "./src/js/modules/popups.js");
...
window.addEventListener("DOMContentLoaded", function () {
  Object(_modules_adaptiveElements__WEBPACK_IMPORTED_MODULE_2__["default"])(); // scrollToAnchor();
  ...
  new _modules_Forms__WEBPACK_IMPORTED_MODULE_7__["default"](".form_section").init();
  new _modules_Forms__WEBPACK_IMPORTED_MODULE_7__["default"](".form__sale").init();
  var btns = document.querySelectorAll("[data-btn]");
  btns.forEach(function (btn) {
    btn.addEventListener("click", function () {
      //   if (btn.type === "button") {
      //  console.log(this)
      Object(_modules_modalsEvents__WEBPACK_IMPORTED_MODULE_6__["default"])(this);
      new _modules_popups__WEBPACK_IMPORTED_MODULE_8__["default"](".modal").openModal(); // }
    });
  });

  function headerFixed() {
    var header = _modules_elements__WEBPACK_IMPORTED_MODULE_3__["page"].querySelector(".header");
...
/* harmony import */ var _popups__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./popups */ "./src/js/modules/popups.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./elements */ "./src/js/modules/elements.js");
...
var content = {
  ...
  thankTitle: {
    ru: "Менеджер свяжется с Вами в ближайшее время!",
    ua: "Менеджер зв'яжеться з Вами найближчим часом!"
  }
};
...
var Form = /*#__PURE__*/function () {
  function Form(form) {
    ...
    this.inputs = this.form.querySelectorAll("input"); // this.isRu = location.pathname === '/ru/';
  ...
  _createClass(Form, [{
      ...
      this.inputs.forEach(function (input) {
        if (input.name === "name") {
          if (!input.value.trim()) {
            ...
            input.nextElementSibling.innerHTML = "".concat(!_this.isRu ? field.ua : field.ru);
          ...
          if (input.value.indexOf("_") === -1) {
            ...
            input.parentNode.classList.add("invalid");
            input.nextElementSibling.innerHTML = "".concat(!_this.isRu ? field.ua : field.en);
            return isValid = false;
          }
        }
      });

      if (validator.name && validator.tel) {
        return isValid;
      }
    }
  }, {
    ...
    value: function checkNameInput(input) {
      ...
      input.addEventListener("input", function () {
        if (input.value.length >= 2) {
          ...
          _this3.formData.name = input.value.trim();
          isValid = true;
        } else {
        ...
        if (!isValid) {
          input.nextElementSibling.innerHTML = "".concat(!_this3.isRu ? name.ua : name.en);
        } else {
          input.nextElementSibling.innerText = "";
        }
      });
    ...
    key: "checkModelInput",
    value: function checkModelInput(input) {
      var _this4 = this;

      input.addEventListener("input", function () {
        _this4.formData.car = input.value.trim();
      });
    }
  }, {
    key: "checkPhoneInput",
    value: function checkPhoneInput(input) {
      ...
      input.addEventListener("input", function () {
        if (input.value.indexOf("_") === -1) {
          ...
          _this5.formData.phone = input.value;
          isValid = true;
        } else {
        ...
        if (!isValid) {
          input.nextElementSibling.innerHTML = "".concat(!_this5.isRu ? template.ua : template.en);
        } else {
          input.nextElementSibling.innerText = "";
        }
      });
    ...
    value: function resetForm(btn) {
      var send = content.send;
      btn.classList.remove("disabled");
      btn.innerHTML = "".concat(!this.isRu ? send.ua : send.ru);
      this.form.reset();
      this.inputs.forEach(function (input) {
    ...
    key: "postData",
    value: function () {
      var _postData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data, btn) {
        var thankTitle, modalText, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                thankTitle = content.thankTitle;
              ...
              case 6:
                ...
                _elements__WEBPACK_IMPORTED_MODULE_10__["modalBody"].innerHTML = "\n          <button type=\"button\" class=\"modal__close pos-a\"><svg class=\"icon\"><use xlink:href=\"#close\"></use></svg></button>\n          ";
                modalText.innerHTML = "\n      <div class=\"pic m-a\">\n           <svg class=\"icon\">\n      <use xlink:href=\"#cheked\"></use>\n    </svg>\n      </div>\n \n      <h2 class=\"fz-40 t-white\">   ".concat(!this.isRu ? thankTitle.ua : thankTitle.en, "</h2>\n      \n      ");
                _elements__WEBPACK_IMPORTED_MODULE_10__["modalBody"].classList.add("success");
                _elements__WEBPACK_IMPORTED_MODULE_10__["modalBody"].appendChild(modalText);
                this.resetForm(btn);
                setTimeout(function () {
                  new _popups__WEBPACK_IMPORTED_MODULE_9__["default"](".modal").openModal();
                }, 400);
                _context.next = 25;
                break;
              ...
              case 15:
                ...
                modalText.innerText = !this.isRu ? this.message.failure.ua : this.message.failure.en;
                _elements__WEBPACK_IMPORTED_MODULE_10__["modalBody"].classList.add("error");
                _elements__WEBPACK_IMPORTED_MODULE_10__["modalBody"].appendChild(modalText);
                modalText.insertAdjacentHTML("beforebegin", "<div class='pic'><svg class=\"icon\">\n      <use xlink:href=\"#error\"></use>\n    </svg></div>");
                this.resetForm(btn);
                new _popups__WEBPACK_IMPORTED_MODULE_9__["default"](".modal").openModal();
    ...
    value: function init() {
      ...
      this.form.addEventListener("submit", function (e) {
        ...
        if (_this6.validateEmptyField()) {
          e.submitter.classList.add("disabled");
          e.submitter.innerHTML = "<svg class=\"icon\">\n        <use xlink:href=\"#spinner\"></use>\n      </svg>";

          if (_this6.form.classList.contains("form_sign")) {
            _this6.formData.title = "\u0417\u0430\u044F\u0432\u043A\u0430 - ".concat(_this6.form.querySelector("h2").dataset.combo);
          }

          if (_this6.form.classList.contains("form__sale")) {
            _this6.formData.title = "Форма внизу сайта на знижку 10%";
          }

          if (_this6.form.classList.contains("form_callback")) {
            _this6.formData.title = "Передзвоніть мені";
          }

          _this6.postData(_this6.path, _this6.formData, e.submitter);
        }
      });
    }
  }]);
...
var adaptiveElements = function adaptiveElements() {
  var headerSocial = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header__social");
  var headerContact = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header__contacts");
  var langSwitcher = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".lang-switcher");
  ...
  if (matchMedia("(max-width: 992px)").matches) {
    ...
    address.innerText = "м. Київ, вул. Деміївська 5А";
    address.href = "https://www.google.com/maps/dir/50.4282114,30.6104034/%D1%83%D0%BB.+%D0%94%D0%B5%D0%BC%D0%B5%D0%B5%D0%B2%D1%81%D0%BA%D0%B0%D1%8F,+5%D0%90,+%D0%9A%D0%B8%D0%B5%D0%B2,+02000/@50.4072633,30.5136318,16.88z/data=!4m9!4m8!1m1!4e1!1m5!1m1!1s0x40d4cf314913b93d:0x76cbfc59f3ab1bbc!2m2!1d30.514047!2d50.406077";
    headerContact.append(address);
    var gmail = document.createElement("a");
    gmail.innerText = "mail@aesthetics.kiev.ua";
    gmail.href = "mailto:mail@aesthetics.kiev.ua";
    headerContact.append(gmail);
    var title = document.createElement("h3");
    title.innerText = "Контакти";
    headerContact.prepend(title);
    headerMenu.append(headerSocial);
    headerMenu.append(headerContact);
    headerMenu.append(langSwitcher);
    _elements__WEBPACK_IMPORTED_MODULE_0__["header"].append(headerMenu);
  ...
  if (matchMedia("(max-width: 600px)").matches) {
    var headerBtn = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".btn");
    headerBtn.remove();
  }
};
...
/*!************************************!*\
  !*** ./src/js/modules/elements.js ***!
  \************************************/
/*! exports provided: page, header, footer, modal, btnsCallBack, form, modalBody */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnsCallBack", function() { return btnsCallBack; });
...
var btnsCallBack = page.querySelectorAll('.btn-callback');
...
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./elements */ "./src/js/modules/elements.js");
/* harmony import */ var _Forms__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Forms */ "./src/js/modules/Forms.js");
...
var services = [{
  ...
  inrerior: {
    ru: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Est aperiam earum voluptatem voluptate architecto. Quaerat eos accusamus atque qui, ipsum, labore animi ipsa pariatur, aspernatur molestias corporis sequi numquam aliquam.",
    ua: "Сам біль важливий для основної жирової еліти. Система - надзвичайно розважальне задоволення. Ми звинувачуємо його в тому, що він шукає їх, а той, хто працею самого розуму виробляється з праці розуму, відкидає, що це ніколи не послідує за будь-якими проблемами тіла."
  }
}, {
  carpet: {
    ru: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Est aperiam earum voluptatem voluptate architecto. Quaerat eos accusamus atque qui, ipsum, labore animi ipsa pariatur, aspernatur molestias corporis sequi numquam aliquam.",
...
function modalsEvents(target) {
  ...
  var titleCallback = content.titleCallback,
      titleSign = content.titleSign,
      name = content.name,
      model = content.model,
      send = content.send;
  var isRu = location.pathname === "/ru/";

  if (target.hasAttribute("data-callback")) {
    _elements__WEBPACK_IMPORTED_MODULE_14__["modalBody"].classList.add("modal__callback");
    modalForm.innerHTML = "\n    <form class=\"form form_callback\">\n    <h2 class=\"fz-24\">".concat(!isRu ? titleCallback.ua : titleCallback.ru, "</h2>\n    ").concat(formBody(), "\n    </form>\n    ");
    _elements__WEBPACK_IMPORTED_MODULE_14__["modalBody"].appendChild(modalForm);
    new _Forms__WEBPACK_IMPORTED_MODULE_15__["default"](".form_callback").init();
  }

  if (target.hasAttribute("data-sign")) {
    _elements__WEBPACK_IMPORTED_MODULE_14__["modalBody"].classList.add("modal__sign");
    modalForm.innerHTML = "\n    <form class=\"form form_sign\">\n                    <h2 class=\"fz-24\" data-combo='".concat(target.dataset.sign, "'>\n                    ").concat(!isRu ? titleSign.ua : titleSign.ru, "</h2> \n                    <div class=\"form__request\">\n                      <div class=\"form__item\">\n                        <input class=\"f-500 fz-18\" type=\"text\" name=\"model\" placeholder=\"\u041C\u043E\u0434\u0435\u043B\u044C\">\n                        <div class=\"form__message fz-16\"></div>\n                      </div>\n                    ").concat(formBody(), "\n                    </div>\n</form>");
    _elements__WEBPACK_IMPORTED_MODULE_14__["modalBody"].appendChild(modalForm);
    new _Forms__WEBPACK_IMPORTED_MODULE_15__["default"](".form_sign").init();
  }
  ...
  if (target.hasAttribute("data-services")) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (Object.keys(service) == target.dataset.services) {
          var _service$target$datas = service[target.dataset.services],
              ua = _service$target$datas.ua,
  ...
  function formBody() {
    return "                      <div class=\"form__item\">\n\n<input class=\"f-500 fz-18\" type=\"text\" name=\"name\" placeholder=\"".concat(!isRu ? name.ua : name.ru, "\">\n<div class=\"form__message fz-16\"></div>\n<div class=\"form__check\">\n  <svg class=\"icon\">\n    <use xlink:href=\"#check\"></use>\n  </svg>\n</div>\n\n</div>\n<div class=\"form__item\">\n\n<input class=\"f-500 fz-18\" type=\"text\" name=\"tel\">\n<div class=\"form__message fz-16\"></div>\n<div class=\"form__check\">\n  <svg class=\"icon\">\n    <use xlink:href=\"#check\"></use>\n  </svg>\n</div>\n</div>\n<div class=\"form__btn\">\n<button type=\"submit\" class=\"btn \">\n").concat(!isRu ? send.ua : send.ru, "\n</button>\n</div>");
  }
}
  ...
  _createClass(Modal, [{
    ...
    value: function attachModalEvents() {
      ...
      if (this.modal.querySelector(".modal__close")) {
        this.modal.querySelector(".modal__close").addEventListener("click", function () {
    ...
    value: function detachModalEvents() {
      ...
      if (this.modal.querySelector(".modal__close")) {
        this.modal.querySelector(".modal__close").removeEventListener("click", function () {
    ...
    value: function handleOutside(event) {
      var isClickOutside = !!event.target.closest(".modal__body");
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./elements */ "./src/js/modules/elements.js");



var headerNav = _elements__WEBPACK_IMPORTED_MODULE_2__["header"].querySelector(".header__nav");

var scrollToAnchor = function scrollToAnchor() {
  var links = document.querySelectorAll(".scrolTo");
  links.forEach(function (link) {
    link.addEventListener("click", function (event) {
      event.preventDefault();
      var blockID = link.getAttribute("href");
      var headerHeaight = _elements__WEBPACK_IMPORTED_MODULE_2__["header"].offsetHeight;
...
var sliders = function sliders() {
  ...
  //   },
  // });
  var swiperReport = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".gallery-swiper", {
    slidesPerView: 1,
    spaceBetween: 20,
    loop: true,
    navigation: {
      nextEl: ".next_slideGallery",
      prevEl: ".prev_slideGallery"
    }
  });
};

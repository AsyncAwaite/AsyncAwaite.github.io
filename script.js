...
/* harmony import */ var _modules_handleMarquee__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/handleMarquee */ "./src/js/modules/handleMarquee.js");
...
/* harmony import */ var _modules_cryptoBtnEvents__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cryptoBtnEvents */ "./src/js/modules/cryptoBtnEvents.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_handleMarquee__WEBPACK_IMPORTED_MODULE_5__["default"])();
  headerFixed();
  ...
  btns.forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      Object(_modules_cryptoBtnEvents__WEBPACK_IMPORTED_MODULE_7__["default"])();
    });
  });
...
/***/ "./src/js/modules/cryptoBtnEvents.js":
/*!*******************************************!*\
  !*** ./src/js/modules/cryptoBtnEvents.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cryptoBtnEvents; });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
...
function cryptoBtnEvents() {
  var btns = document.querySelectorAll(".crypto__btn");
  ...
  if (btns.length > 0) {
    btns.forEach(function (btn) {
      btn.addEventListener("click", function () {
        ...
        document.querySelector(".purse").querySelector("span").innerText = btn.dataset.purse;
        document.querySelector(".net").querySelector("span").innerText = btn.dataset.net;
      });
    });
  } else {
    return;
...
/***/ "./src/js/modules/handleMarquee.js":
/*!*****************************************!*\
  !*** ./src/js/modules/handleMarquee.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (handleMarquee);
...
function modalsEvents(target) {
  ...
  if (target.hasAttribute("data-help")) {
    modalForm.innerHTML = "\n<div class=\"modal__title\">\n<h2 class=\"form__title fz-32\">\n\u042F\u043A\u0449\u043E \u0432\u0438 \u043C\u0430\u043C\u0430 \u0437 \u0434\u0456\u0442\u044C\u043C\u0438 \u0430\u0431\u043E \u043B\u0456\u0442\u043D\u044F \u043B\u044E\u0434\u0438\u043D\u0430 \u0456 \u043F\u043E\u0442\u0440\u0435\u0431\u0443\u0454\u0442\u0435 \u0434\u043E\u043F\u043E\u043C\u043E\u0433\u0438 \n</h2>\n<h3 class=\"form__subtitle fz-18\">\n\u0437\u0430\u043F\u043E\u0432\u043D\u0456\u0442\u044C \u0431\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430 \u0444\u043E\u0440\u043C\u0443 \u043D\u0438\u0436\u0447\u0435 \u0456 \u043C\u0438 \u0437 \u0432\u0430\u043C\u0438 \u0437\u0432\u2019\u044F\u0436\u0435\u043C\u043E\u0441\u044F \u044F\u043A \u043C\u043E\u0436\u043D\u0430 \u0441\u043A\u043E\u0440\u0456\u0448\u0435\n</h3>\n</div>\n\n<form class=\"form form__help\">\n  <label class=\"form__item form__item_main valid\">\n    <span class=\"fz-14 f-700\">\n      \u0412\u0430\u0448\u0435 \u0456\u043C\u2019\u044F\n    </span>\n    <input class=\"f-700\" type=\"text\" name=\"your-name\" placeholder=\"\u0412\u0430\u0448\u0435 \u0456\u043C\u2019\u044F\">\n    <div class=\"form__message\">4564546456</div>\n  </label>\n  <label class=\"form__item form__item_main\">\n    <span class=\"fz-14 f-700\">\n      \u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0443\n    </span>\n    <input type=\"text\" name=\"your-name\" placeholder=\"\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0443\">\n    <div class=\"form__message\">qweqwrr</div>\n  </label>\n\n  <button type=\"submit\" class=\"btn submit\">\n    \u0412\u0456\u0434\u043F\u0440\u0430\u0432\u0438\u0442\u0438\n  </button>\n\n  </div>\n</form> \n    \n      ";
    _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].querySelector(".modal__body").appendChild(modalForm);
  } else if (target.hasAttribute("data-donate")) {
    ...
    modalForm.innerHTML = "<h2 class=\"form__title f-600 fz-36\">\n    \u041E\u0431\u0435\u0440\u0456\u0442\u044C \u0431\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430 \u043D\u0438\u0436\u0447\u0435 \u0441\u043F\u043E\u0441\u0456\u0431, \u0447\u0438\u043C \u0432\u0438 \u043C\u043E\u0436\u0435\u0442\u0435 \u0434\u043E\u043F\u043E\u043C\u043E\u0433\u0442\u0438:\n  </h2>\n  <div class=\"form__donate\">\n       <div class=\"row\">\n      <div class=\"col-12 col-md-6\">\n        <div class=\"form__money\">\n          <h4 class=\"f-600 \">\n            \u041A\u043E\u0448\u0442\u0430\u043C\u0438\n          </h4>\n          <div class=\"descr fz-14\">\n            \u0426\u0456 \u0441\u043F\u043E\u0441\u043E\u0431\u0438 \u043E\u043F\u043B\u0430\u0442\u0438 \u043F\u0440\u0430\u0446\u044E\u044E\u0442\u044C \u0432 \u0431\u0443\u0434\u044C-\u044F\u043A\u0456\u0439 \u043A\u0440\u0430\u0457\u043D\u0456\n          </div>\n          <div class=\"btns d-flex\">\n            <a href=\"#\" class=\"btn btn_pay\">\n              Lig Pay\n            </a>\n            <a href=\"#\" class=\"btn btn_pay\">\n              Pay Pal\n            </a>\n          </div>\n          <h4 class=\"f-600 \">\n            \u0410\u0431\u043E\n           </h4>\n           <div class=\"crypto d-flex\">\n             <button class=\"crypto__btn\" data-purse=\"0x3d68552bd07b119d605d68d680206bf84e3b3294\" data-net=\"Bitcoin\">\n               <div class=\"btc\">\n                 \n               </div>\n               <span>Bitcoin</span>\n              </button>\n              <button class=\"crypto__btn\" data-purse=\"0x3d68552bd07b119d605d68d680206bf84e3b3294\" data-net=\"ERC20\">\n                <div class=\"eth\"> </div>\n                <span>Etherium</span>\n              </button>\n              <button class=\"crypto__btn\" data-purse=\"TUFzTeNr1hPdtjqmqegf62iGuEo9rS6wZw\" data-net=\"TRC20\">\n                <div class=\"usdt\" > </div>\n\n                <span>Tether<br>\n                  (USDT)</span>\n              </button>\n\n           </div>\n           <div class=\"crypto__btns\">\n             <div class=\"purse fz-16\">\n               <h5 class=\"f-400\">\u0413\u0430\u043C\u0430\u043D\u0435\u0446\u044C</h5>\n              <span></span>\n             </div>\n             <div class=\"net\">\n              \u041C\u0435\u0440\u0435\u0436\u0430: \n              <span>Bitcoin</span>\n              \n             </div>\n\n           </div>\n        </div>\n      </div>\n      <div class=\"col-12 col-md-6\">\n        <div class=\"form__things\">\n          <h4 class=\"f-600 \">\n            \u0420\u0435\u0447\u0438\u043C\u0430\n          </h4>\n          <div class=\"descr fz-14\">\n            \u0417\u0430\u043F\u043E\u0432\u043D\u0456\u0442\u044C \u0431\u0443\u0434\u044C-\u043B\u0430\u0441\u043A\u0430 \u0444\u043E\u0440\u043C\u0443 \u043D\u0438\u0436\u0447\u0435 \u0456 \u043C\u0438 \u0437 \u0432\u0430\u043C\u0438 \u0437\u0432\u044F\u2019\u0436\u0435\u043C\u043E\u0441\u044C.\n          </div>\n        </div>\n        <form class=\"form\">\n          <label class=\"form__item form__item_main valid\">\n            <span class=\"fz-14 f-500\">\n              \u0412\u0430\u0448\u0435 \u0456\u043C\u2019\u044F\n            </span>\n            <input class=\"f-600\" type=\"text\" name=\"your-name\" placeholder=\"\u0412\u0430\u0448\u0435 \u0456\u043C\u2019\u044F\">\n            <div class=\"form__message\">4564546456</div>\n          </label>\n          <label class=\"form__item form__item_main\">\n            <span class=\"fz-14 f-500\">\n              \u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0443\n            </span>\n            <input type=\"text\" name=\"your-name\" placeholder=\"\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0443\">\n            <div class=\"form__message\">qweqwrr</div>\n          </label>\n          <label class=\"form__item form__item_main in-valid\">\n            <span class=\"fz-14 f-500\">\n              \u041D\u0430\u043F\u0438\u0449\u0456\u0442\u044C \u044F\u043A\u0430 \u0441\u0430\u043C\u0435 \u0434\u043E\u043F\u043E\u043C\u043E\u0433\u0430 \u0434\u043B\u044F \u0432\u0430\u0441 \u0437\u0430\u0440\u0430\u0437 \u043D\u0435\u043E\u0431\u0445\u0456\u0434\u043D\u0430\n            </span>\n            <textarea></textarea>\n            <div class=\"form__message\">12314</div>\n          </label>\n          <button type=\"submit\" class=\"btn submit\">\n            \u0412\u0456\u0434\u043F\u0440\u0430\u0432\u0438\u0442\u0438\n          </button>\n        </form>\n\n      </div>\n    </div>\n  </div>\n    ";
    _elements__WEBPACK_IMPORTED_MODULE_0__["modal"].querySelector(".modal__body").appendChild(modalForm);
  }
...
var sliders = function sliders() {
  ...
  //   centeredSlides: false,
  //   navigation: {
  //     nextEl: ".swiper-project__next_slide",
  //     prevEl: ".swiper-project__prev_slide",
  //   },
  //   breakpoints: {
  //     1200: {
  //       slidesPerView: 3,

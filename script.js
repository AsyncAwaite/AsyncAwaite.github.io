...
/* harmony import */ var _modules_upload__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/upload */ "./src/js/modules/upload.js");
...
/* harmony import */ var _modules_elements__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/elements */ "./src/js/modules/elements.js");
...
// import createAds2 from "./modules/createAds2";
...
window.addEventListener("DOMContentLoaded", () => {
  try {
    ...
    Object(_modules_upload__WEBPACK_IMPORTED_MODULE_3__["default"])("#file", {
      multi: true,
      accept: [".png", ".jpg", ".jpeg", ".gif"] // onUpload(files, blocks) {
    ...
    function headerFixed() {
      if (matchMedia("(max-width: 600px)").matches) {
        if (window.pageYOffset > 40) {
          _modules_elements__WEBPACK_IMPORTED_MODULE_7__["header"].classList.add("header_fixed");
        } else {
          _modules_elements__WEBPACK_IMPORTED_MODULE_7__["header"].classList.remove("header_fixed");
        }
      } else {
    ...
    new _modules_Dropdown__WEBPACK_IMPORTED_MODULE_6__["default"](".region-materials").init("region");
    new _modules_Dropdown__WEBPACK_IMPORTED_MODULE_6__["default"](".region-help").init("region"); // const types = document.querySelectorAll('[name="checkbox-types"]');
    // const profession = document.querySelectorAll(
    //   '[name="checkbox-profession"]'
    // );
    // const btnTelegram = document.querySelectorAll("[data-telegram]");
    // if (btnTelegram) {
    //   btnTelegram.forEach((btn) => {
    //     btn.addEventListener("click", () => {
    //       gtag("event", "click", { event_category: "dobrobat_in_ua_bot" });
    //     });
    //   });
    // }
    // const formBtn = document.querySelectorAll("[data-from]");
    // formBtn.forEach((item) => {
    //   item.addEventListener("click", () => {
    //     document.querySelector('[data-target="#help-form"]').click();
    //   });
    // });
    // if(document.querySelector('[data-donate]')){
    //   document.querySelector('[data-donate]').addEventListener('click', () => {
    //     new Modal(".modal-donate").openModal();
    //   })
    // }
    // if (document.querySelector("[data-about]")) {
    //   document.querySelector("[data-about]").addEventListener("click", () => {
    //     localStorage.setItem("data-about", "true");
    //     location.href = "https://www.dobrobat.in.ua/#about";
    //   });
    // }
    // if (localStorage.getItem("data-about") == "true") {
    //   console.log(localStorage.getItem("data-about"));
    //   localStorage.setItem("data-about", "false");
    ...
    //     localStorage.setItem("data-form", "true");
    //     location.href = "https://www.dobrobat.in.ua/#form";
    //   });
    // }
    // if (localStorage.getItem("data-form") == "true") {
    //   localStorage.setItem("data-form", "false");
    //   document.querySelector('[data-target="#help-form"]').click();
    // }
    ...
    //     if (target.classList.contains("form-materials")) {
    //       form.title = 0;
    //       document.querySelector("#regionTab").value = selected.region;
    //       form.region = selected.region;
    //       // Для передачи данных в Контакт форму
    //     } else {
    //       form.title = 1;
    //       document.querySelector("#helpTab").value = selected.region;
    //       form.region = selected.region;
    //       // Для передачи данных в Контакт форму
    //     }
    ...
    //           break;
    //         case "your-email":
    //           form.mail = input.value;
    //           break;
    //         case "your-city":
    //           form.city = input.value;
    //           break;
    //         case "your-materials":
    //           form.materials = input.value;
    //           break;
    //       }
    //     });
    ...
    //     types.forEach((input) => {
    //       if (input.checked) {
    //         form.types = [input.value, ...form.types];
    //       }
    //     });
    //     form.types.join(",");
    //     profession.forEach((input) => {
    //       if (input.checked) {
    //         form.profession = [input.value, ...form.profession];
    //       }
    //     });
    //     form.profession.join(",");
    //     for (let key in form) {
    //       data.append(`${key}`, `${form[key]}`);
    //     }
    //     data.append(`info`, `${area.value}`);
    //     const url = window.location.search;
    //     getUtmParameter(url, data);
    ...
    //         case "your-materials":
    //           if (input.checked) {
    //             return (form.materials = input.value);
    //           }
    //           break;
    //       }
    //     });
  ...
  if (document.querySelector(".advertisement")) {
    ...
    mBtns.forEach(item => {
      item.addEventListener("click", () => {
        ...
        if (item.dataset.modals === "form") {
          new _modules_popups__WEBPACK_IMPORTED_MODULE_8__["default"](".modal-form").openModal();
          return;
        }
    ...
    <ul>
      ...
      `;
        new _modules_popups__WEBPACK_IMPORTED_MODULE_8__["default"](".modal-number").openModal();
      });
    });
...
const adaptiveElements = () => {
  if (matchMedia("(max-width: 992px)").matches) {
    ...
    menu.querySelector('.menu__item-sub').insertAdjacentHTML('afterend', subMenu.innerHTML); // subMenu.remove();
  ...
  if (matchMedia("(max-width: 660px)").matches) {
    headerNav.appendChild(_elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector('[data-renaissance]'));
...
const base = {
  ...
  //   "Теплотехник",
  // ],
  typesWork: ["Оздоблення/ремонт", "Вікна/двері/балкони", "Побутовий ремонт", "Електрика", "Розбір розвалин", "Монтаж/демонтаж", "Інше"],
...
/*!************************************!*\
  !*** ./src/js/modules/elements.js ***!
  \************************************/
/*! exports provided: page, header, footer, modal, btnsCallBack, form */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const modal = document.querySelector('.modal');
const btnsCallBack = page.querySelectorAll('.btn-callback');
...
const gallerySlider = () => {
  ...
  if (document.querySelector(".news-single")) {
    const swiperNewsSingle = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".news-single__gallery", {
      slidesPerView: 1,
      spaceBetween: 0,
      loop: false,
      centeredSlides: false,
      navigation: {
        nextEl: ".next_slideNewsSingle",
        prevEl: ".prev_slideNewsSingle"
      },
      autoplay: {
        delay: 8000
      }
  ...
  if (document.querySelector(".celebrity")) {
    const swiperCelebrity = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".celebrity", {
      ...
      loop: true,
      navigation: {
        nextEl: ".next_celebrity",
        prevEl: ".prev_celebrity"
      },
      autoplay: {
        delay: 4000
      },
...
class Modal {
  ...
  closeModal() {
    ...
    if (this.modal.classList.contains("modal-form")) {
      setTimeout(() => {
        modalBody.innerHTML = ``;
      }, 700);
    }
...
const headerNav = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header__nav");
...
const scrollToAnchor = function () {
  ...
  links.forEach(link => {
    link.addEventListener("click", function (event) {
      ...
      if (blockID === '#about' && location.pathname !== "/") {
        location.href = "https://www.dobrobat.in.ua/#about";
      }
...
function upload(selector) {
  ...
  let files = []; // const onUpload = options.onUpload ?? noop

  const input = document.querySelector(selector); // const preview = element('div', ['preview'])

  const open = document.querySelector("[data-upload]");
  const container = document.querySelector("[data-container]"); // const upload = element('button', ['btn', 'primary'], 'Загрузить')
  ...
  const changeHandler = event => {
    ...
    if (!uploadFiles.length || uploadFiles.length > 5) {
      return;
    }
    ...
    files.forEach((file, i) => {
      ...
      reader.onload = () => {
        ...
        <div class="name fz-14 "><span>${file.name}</span></div>
        <div class="delete" data-name="${file.name}">&times;</div>
      </div>
          `);
      };
  ...
  const removeHandler = event => {
    ...
    files = files.filter(file => file.name !== name); // if (!files.length) {
    //   upload.style.display = 'none'
    // }
  ...
  container.addEventListener("click", removeHandler); // upload.addEventListener('click', uploadHandler)
}

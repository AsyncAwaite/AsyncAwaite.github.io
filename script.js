...
/* harmony import */ var _modules_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/elements */ "./src/js/modules/elements.js");
...
/* harmony import */ var _modules_modalsEvents__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modalsEvents */ "./src/js/modules/modalsEvents.js");
...
window.addEventListener("DOMContentLoaded", () => {
  Object(_modules_adaptiveElements__WEBPACK_IMPORTED_MODULE_0__["default"])(); // scrollToAnchor();

  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_3__["default"])();
  headerFixed();
  ...
  btns.forEach(btn => {
    btn.addEventListener("click", function () {
      Object(_modules_modalsEvents__WEBPACK_IMPORTED_MODULE_4__["default"])(this);
      new _modules_popups__WEBPACK_IMPORTED_MODULE_6__["default"](".modal").openModal();
    });
  });

  function headerFixed() {
    const header = _modules_elements__WEBPACK_IMPORTED_MODULE_1__["page"].querySelector(".header");
...
class Form {
    ...
    this.inputs.forEach(input => {
      if (input.name === "name") {
        if (!input.value.trim()) {
          ...
          input.nextElementSibling.innerHTML = `${!isEn ? field.ua : field.en}`;
        ...
        if (input.value.indexOf("_") === -1) {
          ...
          input.parentNode.classList.add("invalid");
          input.nextElementSibling.innerHTML = `${!this.isEn ? field.ua : field.en}`;
          return isValid = false;
        }
      }
    });
  ...
  checkNameInput(input) {
    ...
    input.addEventListener("input", () => {
      ...
      if (!isValid) {
        input.nextElementSibling.innerHTML = `${!this.isEn ? name.ua : name.en}`;
      } else {
        input.nextElementSibling.innerText = "";
      }
    });
  ...
  checkPhoneInput(input) {
    ...
    input.addEventListener("input", () => {
      ...
      if (!isValid) {
        input.nextElementSibling.innerHTML = `${!this.isEn ? template.ua : template.en}`;
      } else {
        input.nextElementSibling.innerText = "";
      }
    });
  ...
  resetForm(btn) {
    ...
    btn.innerHTML = `${!this.isEn ? send.ua : send.en}`;
    this.form.reset();
    this.inputs.forEach(input => {
  ...
  async postData(url, data, btn) {
    if (this.form.classList.contains("form__help")) {
      new _popups__WEBPACK_IMPORTED_MODULE_1__["default"](".modal").clearModal();
    }
    ...
    try {
      ...
      `;
      _elements__WEBPACK_IMPORTED_MODULE_2__["modal"].querySelector(".modal__body").classList.add("success");
      _elements__WEBPACK_IMPORTED_MODULE_2__["modal"].querySelector(".modal__body").appendChild(modalText);
      this.resetForm(btn);
      ...
      _elements__WEBPACK_IMPORTED_MODULE_2__["modal"].querySelector(".modal__body").classList.add("error");
      _elements__WEBPACK_IMPORTED_MODULE_2__["modal"].querySelector(".modal__body").appendChild(modalText);
      this.resetForm(btn);
      new _popups__WEBPACK_IMPORTED_MODULE_1__["default"](".modal").openModal();
...
const headerWrapper = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header-wrapper ");

const adaptiveElements = () => {
  const headerInfo = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector('.header__info');
  const headerProjects = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header__projects");
  const headerContact = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".header__contacts");
  const langSwitcher = _elements__WEBPACK_IMPORTED_MODULE_0__["header"].querySelector(".lang-switcher");
...
const sliders = () => {
  const aboutSlider = document.querySelector(".swiper-about");
  const swiperAbout = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-about", {
    ...
    on: {
      ...
      //   this.el.nextSibling.querySelector(
      //     ".counter__current"
  ...
  if (document.querySelector(".team-wrapper")) {
    const swiperTeam = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-team", {
      slidesPerView: 4,
      spaceBetween: 12,
      loop: true,
      runCallbacksOnInit: true,
...
function countSlides(t) {
  ...
  t.el.nextSibling.querySelector(".counter__total").innerHTML = `0${numOfSlides}`;
}

function changeCount(t) {
  var currentSlide = t.realIndex + 1;
  t.el.nextSibling.querySelector(".counter__current").innerHTML = `0${currentSlide}`;
}

...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_mobileAdaptation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/mobileAdaptation */ "./src/js/modules/mobileAdaptation.js");
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders */ "./src/js/modules/sliders.js");
/* harmony import */ var _modules_scrollToAnchor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scrollToAnchor */ "./src/js/modules/scrollToAnchor.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_mobileAdaptation__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_render__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["swiperSliders"])();
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_scrollToAnchor__WEBPACK_IMPORTED_MODULE_2__["default"])();
  var promoHeight = promo.scrollHeight;
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      ...
      this.textarea.forEach(function (item) {
        item.value = "";
      });
    }
  }, {
    ...
    key: "checkNameInputs",
    value: function checkNameInputs() {
      var _this = this;
    ...
    value: function checkPhoneInputs() {
      ...
      inputs.forEach(function (input) {
        _this2.createMask(input);

        input.addEventListener("input", function () {
          if (input.value.indexOf("_") === -1) {
            input.nextElementSibling.textContent = "";
            _this2.req.phone = true;
          } else {
            input.nextElementSibling.textContent = "Введите согласно шаблона";
          }
        });
      });
    }
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener("submit", function (e) {
          var blError = item.querySelector(".form__block_error");
          var messageBox = blError.querySelector(".form__status");
          e.preventDefault();
          var loadMessage = document.createElement('img');
          loadMessage.src = _this3.message.loading;
          loadMessage.style.cssText = "\n            display: block;\n            margin: 0 auto;\n        ";
          messageBox.insertAdjacentElement('afterbegin', loadMessage);

          if (_this3.req.phone && _this3.req.name) {
            var formData = new FormData(item);

            _this3.postData(_this3.path, formData).then(function (res) {
              messageBox.innerHTML = "";
              Object(_modal__WEBPACK_IMPORTED_MODULE_9__["closeModal"])(".modal");
              setTimeout(function () {
                Object(_modal__WEBPACK_IMPORTED_MODULE_9__["openModal"])(".modal", "data-thank");
              }, 1000);
            }).catch(function () {
              messageBox.textContent = _this3.message.failure;
            }).finally(function () {
              _this3.clearInputs();
...
var gallerySlider = function gallerySlider() {
  var itemsServices = document.querySelectorAll('.item-services');
  itemsServices.forEach(function (itemService) {
    var galleryBox = itemService.querySelector(".gallery-box");
    var galleryItems = galleryBox.querySelectorAll(".gallery-box__item");
    var galleryNav = itemService.querySelector(".item-services__gallery-nav");
    var prevG = galleryNav.querySelector(".prev");
    var nextG = galleryNav.querySelector(".next");
    var counter = 1;
    showSlides(counter);
    nextG.addEventListener("click", function () {
      galleryItems[counter - 1].classList.remove("active");
      console.log(1);
      plusSlides(1);
      galleryItems[counter - 1].classList.add("active");
    });
    prevG.addEventListener("click", function () {
      galleryItems[counter - 1].classList.remove("active");
      plusSlides(-1);
      galleryItems[counter - 1].classList.add("slideInRight");
    }); // functions
    ...
    function remove(arr, indexes) {
      //Удаляем ненужные элементы с масива
...
/***/ "./src/js/modules/mobileAdaptation.js":
/*!********************************************!*\
  !*** ./src/js/modules/mobileAdaptation.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var mobileAdaptation = function mobileAdaptation() {
  var page = document.querySelector(".page");
  var header = page.querySelector(".header");
  var menu = header.querySelector(".header__nav");
  var btnPromo = header.querySelector(".header__btn");
  var hamb = header.querySelector(".hamburger");
  var main = document.querySelector("main");
  var social = main.querySelector(".social");
  var menuServices = document.querySelector('.menu-services');
  ...
  function dynamic() {
    ...
    if (w < 790) {
      ...
      menu.className = "sidebar__nav";
      social.className = "sidebar__social social";
      sidebar.appendChild(menu);
      sidebar.appendChild(social);
      frag.appendChild(sidebar);
      page.appendChild(frag);
      menuServices.classList.remove('swiper-no-swiping');
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (mobileAdaptation);
...
function closeModal(modalSelector) {
  ...
  var contents = modal.querySelectorAll(".modal__content");
...
function openModal(modalSelector, str) {
  var modal = document.querySelector(modalSelector);
  var contents = modal.querySelectorAll(".modal__content");
  contents.forEach(function (item) {
...
/***/ "./src/js/modules/modalService.js":
/*!****************************************!*\
  !*** ./src/js/modules/modalService.js ***!
  \****************************************/
/*! exports provided: default */
...
var modalService = function modalService() {
  ...
  var dropTrigger = modal.querySelector(".drop");
  var dropMenu = modal.querySelector(".form__list");
  var dropItems = dropMenu.querySelectorAll(".form__list-item");
  var serviceInput = modal.querySelector('[name="service"]');
  var ss = modal.querySelector(".ss");
  ...
  dropTrigger.parentElement.addEventListener("click", function (e) {
    openDrop();

    if (e.target.classList.contains("form__list-item")) {
      removeActive(dropItems);
  ...
  function openDrop() {
    dropTrigger.classList.add("open");
...
/* harmony import */ var core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/es.function.name.js */ "./node_modules/core-js/modules/es.function.name.js");
/* harmony import */ var core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _sliderServicesMenu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sliderServicesMenu */ "./src/js/modules/sliderServicesMenu.js");
/* harmony import */ var _gallerySlider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./gallerySlider */ "./src/js/modules/gallerySlider.js");
/* harmony import */ var _servicesTabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./servicesTabs */ "./src/js/modules/servicesTabs.js");
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sliders */ "./src/js/modules/sliders.js");
/* harmony import */ var _modalService__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modalService */ "./src/js/modules/modalService.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
...
var render = function render() {
  var price = getPrice().then(function (data) {
    renderServicesMenu(".menu-services", data);
    renderServicesItems(".services__main", data);
    renderServicesModal('.form__list', data);
    Object(_modalService__WEBPACK_IMPORTED_MODULE_9__["default"])();
    Object(_sliders__WEBPACK_IMPORTED_MODULE_8__["swiperServices"])();
    Object(_servicesTabs__WEBPACK_IMPORTED_MODULE_7__["default"])();
    Object(_gallerySlider__WEBPACK_IMPORTED_MODULE_6__["default"])();
    var modal = document.querySelector(".modal");
    var modalBtns = document.querySelectorAll(".btn_modal");
    var modalWrapper = document.querySelector('.modal-wrapper');
    modalBtns.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        if (this.hasAttribute("data-consult")) {
          Object(_modal__WEBPACK_IMPORTED_MODULE_10__["openModal"])(".modal", "data-consult");
        } else {
          Object(_modal__WEBPACK_IMPORTED_MODULE_10__["openModal"])(".modal", "data-services");
          modalWrapper.classList.toggle('adaptive');
        }
      });
    });
    modal.addEventListener("click", function (e) {
      if (e.target === modal || e.target.getAttribute("data-close") == "") {
        Object(_modal__WEBPACK_IMPORTED_MODULE_10__["closeModal"])(".modal");
      }
    });
    new _forms__WEBPACK_IMPORTED_MODULE_11__["default"]("form").init();
  }).catch(function (err) {
  ...
  function _getPrice() {
    _getPrice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var response;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("./assets/services/price.json").then(function (res) {
                return res.json();
              });
...
function renderServicesMenu(el, arr) {
  var parent = document.querySelector(el);
  var fragment = document.createDocumentFragment();
  arr.forEach(function (item) {
    var menuItem = document.createElement("li");
    menuItem.classList.add("menu-services__item", "swiper-slide");
...
function renderServicesItems(el, arr) {
  var parent = document.querySelector(el);
  var fragment = document.createDocumentFragment();
  arr.forEach(function (item) {
    var servicesItem = document.createElement("div");
    servicesItem.classList.add("item-services"); //галерея

    var itemGallery = document.createElement("div");
    itemGallery.classList.add("item-services__gallery");
    var galleryBox = document.createElement("div");
    galleryBox.classList.add("gallery-box");
    var itemGalleryNav = document.createElement("div");
    itemGalleryNav.classList.add("item-services__gallery-nav");
    itemGalleryNav.innerHTML = " <button class=\"prev\"><svg width=\"15\" height=\"25\" viewBox=\"0 0 15 25\" fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\">\n          <path\n              d=\"M13.9659 11.814L2.40267 0.282708C2.02381 -0.0948779 1.41044 -0.0942432 1.03221 0.284662C0.654286 0.663518 0.655263 1.27724 1.03417 1.65512L11.9091 12.5L1.03378 23.3449C0.654921 23.7229 0.653944 24.3362 1.03182 24.7151C1.22142 24.905 1.46981 25 1.7182 25C1.96595 25 2.21336 24.9057 2.40262 24.717L13.9659 13.1861C14.1484 13.0045 14.2508 12.7575 14.2508 12.5C14.2508 12.2426 14.1481 11.9958 13.9659 11.814Z\"\n              fill=\"white\" />\n      </svg></button>\n\n\n\n      <button class=\"next\">\n      <svg width=\"15\" height=\"25\" viewBox=\"0 0 15 25\" fill=\"none\"\n          xmlns=\"http://www.w3.org/2000/svg\">\n          <path\n              d=\"M13.9659 11.814L2.40267 0.282708C2.02381 -0.0948779 1.41044 -0.0942432 1.03221 0.284662C0.654286 0.663518 0.655263 1.27724 1.03417 1.65512L11.9091 12.5L1.03378 23.3449C0.654921 23.7229 0.653944 24.3362 1.03182 24.7151C1.22142 24.905 1.46981 25 1.7182 25C1.96595 25 2.21336 24.9057 2.40262 24.717L13.9659 13.1861C14.1484 13.0045 14.2508 12.7575 14.2508 12.5C14.2508 12.2426 14.1481 11.9958 13.9659 11.814Z\"\n              fill=\"white\" />\n      </svg>\n      </button>";
    item.images.forEach(function (img, index) {
      var galleryBoxImg = document.createElement("div");
      galleryBoxImg.classList.add("gallery-box__item", "gallery-box__item-".concat(index + 1));
      var div = document.createElement("div");
      div.style.backgroundImage = "url(\"".concat(img, "\")");
      galleryBoxImg.appendChild(div);
      galleryBox.appendChild(galleryBoxImg);
    });
    galleryBox.appendChild(itemGalleryNav);
    itemGallery.appendChild(galleryBox);
    servicesItem.appendChild(itemGallery);
    fragment.appendChild(servicesItem); // Текстовая часть

    var itemDescr = document.createElement("div");
    itemDescr.classList.add("item-services__descr");
    var itemsPrice = document.createElement("div");
    itemsPrice.classList.add("item-services__price");

    if (item.gender !== "") {
      var gender = document.createElement("span");
      gender.textContent = item.gender;
      gender.classList.add("item-services__price-gender");
      itemsPrice.appendChild(gender);
    }

    item.list.forEach(function (listItem) {
      var itemPrice = document.createElement("div");
      itemPrice.classList.add("item-services__price-item");
      var name = document.createElement("div");
      name.classList.add("item-services__price-name");
      name.textContent = listItem.name;

      if (item.descr !== "") {
        var descr = document.createElement("span");
        descr.textContent = listItem.descr;
        name.appendChild(descr);
      }

      var price = document.createElement("div");
      price.classList.add("item-services__price-cost");
      price.textContent = listItem.price;
      itemPrice.appendChild(name);
      itemPrice.appendChild(price);
      itemsPrice.appendChild(itemPrice);
    });
    var itemAbout = document.createElement("div");
    itemAbout.classList.add("item-services__about");
    itemAbout.innerHTML = item.about;
    var itemBtn = document.createElement("button");
    itemBtn.classList.add("btn", "btn__fill", "btn_modal");
    itemBtn.setAttribute("data-services", "");
    itemBtn.innerHTML = "<span class=\"btn__fill_helper\"></span> \n    \u0417\u0430\u043F\u0438\u0441\u0430\u0442\u044C\u0441\u044F \u043D\u0430 \u043F\u0440\u043E\u0446\u0435\u0434\u0443\u0440\u0443";
    itemDescr.appendChild(itemsPrice);
    itemDescr.appendChild(itemAbout);
    itemDescr.appendChild(itemBtn);
    servicesItem.appendChild(itemDescr);
    servicesItem.setAttribute("data-name", "".concat(item.title));
    fragment.appendChild(servicesItem);
  });
  parent.appendChild(fragment);
}

function renderServicesModal(el, arr) {
  var parent = document.querySelector(el);
  var fragment = document.createDocumentFragment();
  arr.forEach(function (item) {
    var menuItem = document.createElement("li");
    menuItem.classList.add("form__list-item");
    menuItem.textContent = item.title;
    fragment.appendChild(menuItem);
  });
  parent.appendChild(fragment);
...
var scrollToAnchor = function scrollToAnchor() {
  ...
  links.forEach(function (link) {
    link.addEventListener("click", function (event) {
      ...
      var headerHeaight = header.offsetHeight;
      window.scrollTo({
        top: document.querySelector("".concat(blockID)).offsetTop - headerHeaight,
        behavior: "smooth"
      });
    });
  });
...
var servicesTab = function servicesTab() {
  var itemsServices = document.querySelectorAll(".item-services");
  var menuServices = document.querySelectorAll(".menu-services__item");
  menuServices.forEach(function (itemMenu) {
    if (itemMenu.classList.contains("swiper-slide-active")) {
      itemMenu.classList.add("active");
    }
  });
  itemsServices.forEach(function (itemService, index) {
    if (index === 0) {
      itemService.classList.add("active");
    }
  });
  menuServices.forEach(function (item, index, arr) {
    item.addEventListener("click", function (e) {
      arr.forEach(function (el) {
  ...
  function showTab(str) {
    itemsServices.forEach(function (itemService) {
      itemService.classList.remove("active");

      if (itemService.dataset.name === str) {
        itemService.classList.add("active");
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (servicesTab);

/***/ }),

/***/ "./src/js/modules/sliderServicesMenu.js":
/*!**********************************************!*\
  !*** ./src/js/modules/sliderServicesMenu.js ***!
  \**********************************************/
/*! exports provided: default */
...
var sliderServicesMenu = function sliderServicesMenu() {
  var sliderParent = document.querySelector(".services__nav");
  var wrapper = sliderParent.querySelector(".menu-services__wrapper");
  var prev = sliderParent.querySelector(".prev");
  var next = sliderParent.querySelector(".next");
  var slides = sliderParent.querySelectorAll(".menu-services__item");
  var slidesField = sliderParent.querySelector(".menu-services");
  var widthSlidesField = window.getComputedStyle(wrapper).width;
  var widthSlide;
  ...
  function nextItem(n) {
    if (offset == widthSlide * (slides.length - n)) {
      offset = 0;
    } else {
      offset += widthSlide;
    }
  ...
  function prevItem(n) {
    if (offset == 0) {
      offset = widthSlide * (slides.length - n);
    } else {
      offset -= widthSlide;
    }
    ...
    slidesField.style.transform = "translateX(-".concat(offset, "px)");
    console.log(offset);
    console.log(widthSlide * (slides.length - n));
  }

  function itemWidth(n) {
    slides.forEach(function (slide, index) {
      var w = deleteNotDigits(widthSlidesField);
      slide.style.width = "".concat(w / n, "px");

      if (index === 0) {
        slide.classList.add("active");
      }

      return widthSlide = w / n;
    });
  }
};

/* harmony default export */ __webpack_exports__["default"] = (sliderServicesMenu);
...
/*!***********************************!*\
  !*** ./src/js/modules/sliders.js ***!
  \***********************************/
/*! exports provided: swiperSliders, swiperServices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperSliders", function() { return swiperSliders; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperServices", function() { return swiperServices; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
...
var swiperSliders = function swiperSliders() {
  var photosSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".photos", {
    slidesPerView: 3,
    spaceBetween: 20,
    loop: true,
    navigation: {
  ...
  var rewiesSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".rewies", {
    slidesPerView: 1,
    spaceBetween: 40,
    loop: true,
    navigation: {
  ...
  var servSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".services__items", {
    slidesPerView: 4,
    spaceBetween: 0,
    loop: true
  });
  var servicesItems = document.querySelectorAll('.item-services');
  servicesItems.forEach(function (item, index, arr) {
    item.addEventListener('click', function () {
      arr.forEach(function (i) {
        i.classList.remove('swiper-slide-active');
        i.classList.remove('swiper-slide-prev');
        i.classList.remove('swiper-slide-next');
      });
...
var swiperServices = function swiperServices() {
  var servSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](".menu-services__wrapper", {
    slidesPerView: 4,
    spaceBetween: 0,
    // loop: true,
    navigation: {
      nextEl: ".next_services",
      prevEl: ".prev_services"
    },
    breakpoints: {
      992: {
        slidesPerView: 4
